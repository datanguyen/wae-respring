...
export class CheckoutForm extends React.Component {
  ...
  onSubmit(e) {
    ...
    if (!isValid) {
      this.setState({ isVerify: !this.state.isVerify })
    }
  }

  handlerFinishCheckout() {
    let { username, email, city, district, ward, number, phone, payment, atmBank, atmNumber, totalPrice } = this.state
    let checkout = { fullname: username, email, city, district, ward, number,
      phone, payment, totalPrice, atmNumber, atmBank }
  ...
  render() {
    let {
      username, email, city, district, ward, number, phone, errors,
      isATM, atmBank, atmNumber, isLoading, isVerify } = this.state
    ...
    return (<VerificationForm handlerFinishCheckout={() => this.handlerFinishCheckout()} />)
  }
