...
import style from './hande.style.scss'

import { CateBarComponent, ProductBox } from '../../../components'

@cssModules(style, { errorWhenNotFound: false})
export class HandmadeView extends React.Component {

  render() {
    let { category, products } = this.props.handmadeApi
    return(
      <div>
...
HandmadeView.propTypes = {
  handmadeApi: React.PropTypes.object.isRequired
}