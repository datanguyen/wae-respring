...
import style from './electronic.style.scss'

import { CateBarComponent, ProductBox } from '../../../components'

@cssModules(style, { errorWhenNotFound: false})
export class ElectronicView extends React.Component {

  render() {
    let { category, products } = this.props.electronicApi
    return(
      <div>
...
ElectronicView.propTypes = {
  electronicApi: React.PropTypes.object.isRequired
}